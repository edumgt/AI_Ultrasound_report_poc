...
from PySide6.QtCore import QThread, Signal, QObject, Qt, QShortcut
...
class Worker(QObject):
    ...
    def __init__(self, audio_q: "queue.Queue[np.ndarray]", stt: WhisperSTT, corrector: TermCorrector, sample_rate: int = 16000):
        super().__init__()
...
class MainWindow(QMainWindow):
    ...
    def _build_prompt(self) -> str:
        ...
        # Whisper에게 "영문 스펠링을 유지하라"는 힌트를 주는 정도
        return (
